...
namespace Microsoft.WindowsAPICodePack.Dialogs
{
    ...
    internal class NativeTaskDialogSettings
    {
        internal NativeTaskDialogSettings()
        {
            ...
            NativeConfiguration.mainIcon = new TaskDialogNativeMethods.IconUnion(IntPtr.Zero);
            NativeConfiguration.footerIcon = new TaskDialogNativeMethods.IconUnion(IntPtr.Zero);
